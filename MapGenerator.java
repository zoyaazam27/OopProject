...
//                map1[j] = 1;  // This means an apple is present
//            }
//        }
//        bricksWidth = 540 / col;   // Width of the fruit (or space for the fruit)
//        bricksHeight = 190 / row;  // Height of the fruit (or space for the fruit)
//
//        // Load the apple image from the package (same directory as your Java files)
//        appleImage = new ImageIcon(getClass().getResource("/com/mycompany/brick/apple.jpg")).getImage();
//    }
//
//    // Draw the apple instead of the brick
...
//
//                    // Optional: Draw the border around the apple
//                    g.setStroke(new BasicStroke(3));
//                    g.setColor(Color.BLACK);
//                    g.drawRect(x, y, bricksWidth, bricksHeight);  // Border for the apple
//                }
//            }
//        }
//    }
//
//    // Set the apple's value to 0 (removes the apple)
